...
<div class="flex h-full">
	...
	<div bind:this={mainEl} class="{($isMobile && $isHide) || !$isMobile ? 'w-full' : 'hidden'}">
		<div class="mt-[52px]" />
		<slot />
	</div>

	<button class="fixed p-6 z-30 bottom-0 right-0" on:click={() => mainEl.scrollIntoView({ behavior: 'smooth',  })}>
