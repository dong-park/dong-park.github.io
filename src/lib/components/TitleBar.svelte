	...
	<div>
		<div class="flex gap-0.5">
			...
			<a
				style="--lv-wait: 1;"
				class="flex items-center gap-1 rounded p-1 transition-colors hover:bg-selection hover:text-body"
				href="https://www.linkedin.com/in/%EB%8F%99%ED%99%98-%EB%B0%95-b847b8258/"
				target="_blank"
			>
				<svg xmlns="http://www.w3.org/2000/svg" width="0.9em" height="0.9em" viewBox="0 0 24 24">
					<path
						fill="currentColor"
						d="M22.225 0H1.77C.79 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.77 24h20.452C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0zM7.257 20.437H3.437V9h3.82v11.437zM5.35 7.433a2.062 2.062 0 01-2.065-2.065 2.064 2.064 0 112.064 2.065zm15.087 13.004h-3.814v-5.569c0-1.328-.026-3.037-1.852-3.037-1.852 0-2.136 1.445-2.136 2.939v5.667H9.72V9h3.674v1.566h.052c.51-.964 1.757-1.852 3.616-1.852 3.874 0 4.58 2.548 4.58 5.862v6.861z"
					/>
				</svg>
			</a>
			<a
