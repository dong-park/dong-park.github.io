	...
	<div class="flex items-center w-full justify-between">
		<div class="flex space-x-2">
			<div class="flex text-sm px-2">
				<button class="px-1 hover:cursor-pointer sm:hover:bg-gray-100 hover:rounded-xl font-sans"
								on:click={() => goto('/')}>
					home
				</button>
				<b>/</b>
		...
		<div>
			<button class="cursor-pointer sm:hover:bg-gray-100 mr-4" on:click={() => navigateTo(paths.length - 2)}>
